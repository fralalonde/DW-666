use crate::midi::{Matcher, Message, Packet};
use crate::midi::route::{RouteContext};
use core::convert::TryFrom;

pub fn capture_sysex(matcher: &mut Matcher, packet: Packet, context: &mut RouteContext) -> bool {
...
pub fn event_print(packet: Packet, _context: &mut RouteContext) -> bool {
