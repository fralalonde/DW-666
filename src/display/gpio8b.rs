...
pub struct GPIO8BParallelInterface<DB0, DB1, DB2, DB3, DB4, DB5, DB6, DB7, CS, DCX, RDX, WRX>
    where
        DB0: IoPin,
        DB1: IoPin,
        DB2: IoPin,
...
GPIO8BParallelInterface<DB0, DB1, DB2, DB3, DB4, DB5, DB6, DB7, CS, DCX, RDX, WRX>
    where
        DB0: IoPin,
        DB1: IoPin,
        DB2: IoPin,
...
for GPIO8BParallelInterface<DB0, DB1, DB2, DB3, DB4, DB5, DB6, DB7, CS, DCX, RDX, WRX>
    where
        DB0: IoPin,
        DB1: IoPin,
        DB2: IoPin,
        ...
        WRX: IoPin,
{
    ...
    fn write_stream<'a>(
        ...
        self.streams += 1;
        if self.streams %128 == 0 {
            rprintln!("streams {} pixels {}", self.streams, self.pixels)
        }
