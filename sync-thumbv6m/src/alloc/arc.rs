...
use core::mem::{self, align_of_val, align_of_val_raw};
...
#[cfg(not(no_global_oom_handling))]
// use core_alloc::alloc::{box_free, WriteCloneIntoRaw};
use core_alloc::alloc::{AllocError, Allocator, Global, Layout};
use core_alloc::borrow::{Cow, ToOwned};
use core_alloc::boxed::Box;
// use core_alloc::rc::is_dangling;
#[cfg(not(no_global_oom_handling))]
...
// impl<T: ?Sized + alloc::rc::MarkerEq> ArcEqIdent<T> for Arc<T> {
//     #[inline]
//     fn eq(&self, other: &Arc<T>) -> bool {
